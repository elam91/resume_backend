...
class Base(Configuration):
    ...
    RESUME_BACKEND_APPS = ['main']
    INSTALLED_APPS = DJANGO_APPS + THIRD_PARTY_APPS + RESUME_BACKEND_APPS
    ...
    MIDDLEWARE = [
        ...
        "resume_backend.middleware.TimezoneMiddleware",
    ...
    DATABASES = values.DatabaseURLValue("postgresql://resume_backend_user:resume_backend_pass@127.0.0.1:5432/resume_backend_db")
...
class Testing(Development):
    ...
    DATABASES = values.DatabaseURLValue( # This is about defaulting to running vs docker db if you don't specify something else
        "postgresql://resume_backend_user:resume_backend_pass@127.0.0.1:5433/resume_backend_db")
